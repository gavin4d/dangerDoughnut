...
#define CONFIG_BT_NIMBLE_GAP_DEVICE_NAME_MAX_LEN 63
...
#define CONFIG_BT_NIMBLE_HID_SERVICE 1
#define CONFIG_BT_NIMBLE_SVC_HID_MAX_INSTANCES 2
#define CONFIG_BT_NIMBLE_SVC_HID_MAX_RPTS 3
